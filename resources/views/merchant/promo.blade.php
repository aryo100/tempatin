                                                        ...
                                                        <div class="modal-body">
															<div class="row">
                                                                ...
                                                                <div class="col-xs-12 col-sm-8">
                                                                    <div class="form-group">
                                                                        <label for="form-field-kode">Tanggal Promo</label>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xs-12 col-sm-4">
                                                                    <div class="form-group">
                                                                        <label for="form-field-kode">Kode</label>

                                                                        <div>
                                                                            <input name="kode" type="text" id="form-field-kode" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xs-12 col-sm-4">
                                                                    <div class="form-group">
                                                                        <label for="form-field-diskon">Diskon</label>
                                                                ...
                                                                <div class="col-xs-12 col-sm-4">
                                                                    <div class="form-group">
                                                                        <label for="form-field-kode">Jumlah Penggunaan</label>

                                                                        <div>
                                                                            <input name="used_times" placeholder="1x/~" value="1" type="number" id="form-field-kode" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xs-12 col-sm-4">
                                                                    <div class="form-group">
                                                                        <label for="form-field-status">Berlaku untuk Ruangan</label>
