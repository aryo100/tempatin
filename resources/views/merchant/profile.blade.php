...
@section('content')
		...
		&nbsp; -->
												<div class="inline middle blue bigger-110"> Your profile is {{$con}} complete </div>

												&nbsp; &nbsp; &nbsp;
												<div style="width:200px;" data-percent="{{$con}}%" class="inline middle no-margin progress progress-striped active pos-rel">
													<div class="progress-bar progress-bar-success" style="width:{{$con}}%"></div>
												</div>
											</div><!-- /.well -->
											@endif
											...
											<form class="form-horizontal" action="{{route('up.user.merchant',$user->id_user)}}" method="post" enctype="multipart/form-data">
												@csrf
												<div class="tabbable">
													...
													<div class="tab-content profile-edit-tab-content">
														<div id="edit-basic" class="tab-pane in active">
															...
															<div class="row">
																<div class="col-xs-12 col-sm-4">
																	...
																	<script>
																		...
																		@if($user->foto_profile)
																			var file="{{asset(str_replace('\\', '/', $user->foto_profile))}}";
																			$('#user-profile-3')
																...
																<div class="col-xs-12 col-sm-8">
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input class="input-medium" type="text" id="form-field-first" value="{{$user->nama_user}}" name="nama" />
																		</div>
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-sm-9">
																	<span class="input-icon input-icon-right">
																		<input type="email" id="form-field-email" name="email" value="{{$user->email}}" />
															...
															<div class="form-group">
																...
																<div class="col-sm-9">
																	<span class="input-icon input-icon-right">
																		<input class="input-medium" name="no_telp" type="text" value="{{$user->no_telp}}" />
															...
															<div class="form-group">
																...
																<div class="col-sm-9">
																	<span class="input-icon input-icon-right">
																		<input class="input-medium" name="no_rek" type="text" value="{{$user->no_rek}}" />
																	</span>
																</div>
															</div>
														</div>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				// $('#id-input-file-3')
				// .ace_file_input('show_file_list', [
				// 	{type: 'image', name: 'name of image', path: 'http://localhost:8000/foto/android-logo-transparent-png-svg-vector-2.png'}
				// ]);
